...
class WbumenudomainListBuilder extends EntityListBuilder {
  ...
  /**
   *
   * {@inheritdoc} We override ::render() so that we can add our own content
   *               above the table.
   *               parent::render() is where EntityListBuilder creates the table
   *               using our
   *               buildHeader() and buildRow() implementations.
   */
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('<p> Liste des domaines configurés. </p>')
    ];
