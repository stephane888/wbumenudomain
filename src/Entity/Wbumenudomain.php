...
class Wbumenudomain extends ContentEntityBase implements ContentEntityInterface {
  ...
  /**
   *
   * {@inheritdoc} When a new entity instance is added, set the user_id entity
   *               reference to
   ...
   *              
   *               In addition, we can define how the field and its content
   *               can be manipulated
   *               in the GUI. The behaviour of the widgets used can be
   *               determined here.
   */
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    // Domaine
    // $fields['hostname'] =
    // BaseFieldDefinition::create('entity_reference')->setLabel(t('
    // Hostname ou nom de domaine '))
    // ->setRequired(TRUE)
    ...
    // Domaine
    // $fields['hostname'] =
    // BaseFieldDefinition::create('list_string')->setLabel(t(' Hostname ou
    // nom de domaine '))
    // ->setRequired(TRUE)
    // ->setDescription(t('Selectionner le nom de domaine'))
    ...
    // ->setDisplayConfigurable('view', TRUE);
    // $fields['first_name'] =
    // BaseFieldDefinition::create('string')->setLabel(t('First Name'))
    ...
    // $fields['gender'] =
    // BaseFieldDefinition::create('list_string')->setLabel(t('Gender'))->setDescription(t('The
    // gender of the Wbumenudomain entity.'))->setSettings(array(
    ...
    // TRUE)->setDisplayConfigurable('view', TRUE);
