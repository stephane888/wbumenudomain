...
use Drupal\wbumenudomain\Wbumenudomain as WbumenudomainUtility;
 ...
 * @ContentEntityType(
 *   id = "wbumenudomain",
 *   label = @Translation("Lien par domaine"),
...
class Wbumenudomain extends ContentEntityBase implements ContentEntityInterface
{
    ...
    /**
     * liste de champs valid Drupal\Core\TypedData\TypedDataManager or /admin/config/system/helpdevel/services/typed_data_manager
     *
    ...
    public static function baseFieldDefinitions(EntityTypeInterface $entity_type)
    {
        ...
        $fields['id'] = BaseFieldDefinition::create('integer')->setLabel(t('ID'))
            ->setDescription(t('The ID of the Wbumenudomain entity.'))
            ->setReadOnly(TRUE);

        // Standard field, unique outside of the scope of the current project.
        $fields['uuid'] = BaseFieldDefinition::create('uuid')->setLabel(t(' UUID '))
            ->setDescription(t(' The UUID of the Wbumenudomain entity. '))
            ->setReadOnly(TRUE);

        // Domaine
        // $fields['hostname'] = BaseFieldDefinition::create('entity_reference')->setLabel(t(' Hostname ou nom de domaine '))
        // ->setRequired(TRUE)
        // ->setDescription(t('Selectionner le nom de domaine'))
        ...
        // Domaine
        // $fields['hostname'] = BaseFieldDefinition::create('list_string')->setLabel(t(' Hostname ou nom de domaine '))
        // ->setRequired(TRUE)
        // ->setDescription(t('Selectionner le nom de domaine'))
        ...
        $fields['lirairy'] = BaseFieldDefinition::create('list_string')->setLabel(t(' Selectionné un style pour ce domaine '))
            ->setRequired(TRUE)
            ->setDescription(t('Selectionner le nom de domaine'))
            ->setSetting('allowed_values_function', [
            '\Drupal\wbumenudomain\Wbumenudomain',
            ...
            ->setDisplayConfigurable('view', TRUE);
        //
        $fields['hostname'] = BaseFieldDefinition::create('wbumenudomaineditlink')->setLabel(t(' Hostname ou nom de domaine(v2) '))
            ->setRequired(TRUE)
            ->setDisplayOptions('form', [
        ...
        // ->setDescription(t('The name of the Wbumenudomain entity.'))
        // ->setSettings(array(
        // 'default_value' => '',
        // 'max_length' => 255,
        // 'text_processing' => 0
        ...
        // ->setDescription(t('The first name of the Wbumenudomain entity.'))
        // ->setSettings(array(
        // 'default_value' => '',
        // 'max_length' => 255,
        // 'text_processing' => 0
